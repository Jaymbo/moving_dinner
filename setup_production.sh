...
echo ""
log_info "Empfohlen: Logrotation für Cronjob-Output einrichten"
echo "  1. Passe den Pfad in logrotate/moving-dinner-backup an deinen User an"
echo "  2. Kopiere die Datei als root:"
echo "     sudo cp logrotate/moving-dinner-backup /etc/logrotate.d/moving-dinner-backup"
echo "  3. Teste die Konfiguration:"
echo "     sudo logrotate -d /etc/logrotate.d/moving-dinner-backup"
